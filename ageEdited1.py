    ...
    if month2 == 0 and day2 == 0 :
        ...
        if month2 < 0 and day2 == 0:
            ...
            if month1 == 4 or month1 ==6 or month1 == 8 or month1 == 11:
                ...
                print("\n")
                if month0 == 4 or month0 == 6 or month0 == 8 or month0 == 11:
                    print("next birthday after {:d}".format(30 - (30 - day2 * -1)))
                elif month0 == 2:
                    print("next birthday after {:d}".format(28 - (30 - day2 * -1)))
                else:
                    print("next birthday after {:d}".format(31 - (30 - day2 * -1)))
            elif month1 == 2:
                print("you have {:d} years".format(year2 - 1).strip())
                print("and 11 months")
                print("and {:d} days ".format(28 - day2 * -1).strip())
                print("\n")
                if month0 == 4 or month0 == 6 or month0 == 8 or month0 == 11:
                    print("next birthday after {:d}".format(30 - (28 - day2 * -1)))
                elif month0 == 2:
                    print("next birthday after {:d}".format(28 - (28 - day2 * -1)))
                else:
                    print("next birthday after {:d}".format(31 - (28 - day2 * -1)))
            else:
                print("you have {:d} years".format(year2 - 1).strip())
                print("and 11 months")
                print("and {:d} days ".format(31 - day2 * -1).strip())
                print("\n")
                if month0 == 4 or month0 == 6 or month0 == 8 or month0 == 11:
                    print("next birthday after {:d}".format(30 - (31 - day2 * -1)))
                elif month0 == 2:
                    print("next birthday after {:d}".format(28 - (31 - day2 * -1)))
                else:
                    print("next birthday after {:d}".format(31 - (31 - day2 * -1)))
